...
const landingCSS = `
  ...
  /* FAQ — FaqAccordion.tsx (moved from the old /home-v2 build, see that
     file's own comment). Values (26px 22px padding, max-height/rotating-
     icon technique, 14.5px/600 question weight) are unchanged from there;
...
const FAQ_ITEMS: FaqAccordionItem[] = [
  {
    ...
    answer: 'Bearing is built on the IPIP-NEO-120, a public-domain Big Five inventory published in peer-reviewed research (Johnson, 2014). Like any self-report questionnaire, it reflects how you answer, so it describes your patterns rather than diagnosing you. The written explanations are generated by AI from your results.',
  },
  {
  ...
  {
    question: 'Is this AI?',
    answer: "Your scores come from the same fixed questionnaire for everyone and are calculated directly from your answers. The written explanation of each pattern is generated by AI from your results, and it can't change your scores.",
  },
  {
    question: 'How is this different from a type test or a chat with AI?',
    answer: 'Type tests sort you into one of a fixed set of four-letter labels. Bearing scores 30 facets of the Big Five and shows specific patterns. A chat with AI tends to reflect what you tell it; Bearing starts from the same 120 statements for everyone before anything is interpreted.',
  },
]
  ...
  return (
    <>
      ...
      <div style={{ background:mkCream, color:mkCharcoal, fontFamily:sans }}>
        ...
        {/* ── FAQ ──────────────────────────────────────────────────── */}
        {/* .section-head reused unchanged (eyebrow + heading). FAQ items
            live in FAQ_ITEMS just below the component, not inline here, so
            FaqAccordion's items prop stays a plain array reference rather
            than a new array literal on every render. */}
        <section className="faq-section">
          <div className="faq-wrap">
            <div className="section-head">
              <div className="mk-eyebrow" style={{ justifyContent:'center', display:'flex' }}>FAQ</div>
